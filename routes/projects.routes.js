...
router.post('/', (req, res, next) => {
    projects_ctrl.createProject(req, (error, results)=>{
        if(error){
            res.status(500).send('create projects error')
            console.log(error)
            next(error)
            return
        }
...
router.get('/', (req, res, next) => {
    projects_ctrl.readProjects((error, results)=>{
        if(error){
            res.status(500).send('get all projects error')
            console.log(error)
            next(error)
            return
        }
...
router.get('/:id', (req, res, next) => {
    projects_ctrl.readProject(req, (error, results)=>{
        if(error){
            res.status(500).send('get one projects error')
            console.log(error)
            next(error)
            return
        }
...
router.put('/:id', (req, res, next) => {
    projects_ctrl.updateProject(req, (error, results)=>{
        if(error){
            res.status(500).send('update projects error')
            console.log(error)
            next(error)
            return
        }
...
router.delete('/:id', (req, res, next) => {
    projects_ctrl.deleteProject(req, (error, results)=>{
        if(error){
            res.status(500).send('delete projects error')
            console.log(error)
            next(error)
            return
        }
